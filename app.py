...
<div class="main-header">
    ...
    <p>Tác giả: Triệu Xuân Năm - Trường PTDTBT Tiểu học Sủng Cháng - ĐT: 096 8992 030</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Triệu Xuân Năm - Trường PTDTBT Tiểu học Sủng Cháng - ĐT: 096 8992 030</div>", unsafe_allow_html=True)
